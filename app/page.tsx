    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {/* New Project Button - ALWAYS WORKS */}
          <Link
            href="/upload"
            ...
            <div className="mt-20 grid md:grid-cols-3 gap-8 text-left">
              <div className="p-6 bg-white rounded-xl border border-gray-200 hover:border-blue-300 transition">
                ...
                <p className="text-sm text-gray-600">
                  Drag and drop your GLB/GLTF floor plans. Support for files up to 50MB with IndexedDB storage.
                </p>
              </div>
              ...
              <div className="p-6 bg-white rounded-xl border border-gray-200 hover:border-blue-300 transition">
                ...
                <p className="text-sm text-gray-600">
                  Explore your space in full 3D with smooth camera controls, realistic lighting, and shadows.
                </p>
              </div>
              ...
              <div className="p-6 bg-white rounded-xl border border-gray-200 hover:border-blue-300 transition">
                ...
                <p className="text-sm text-gray-600">
                  Place and arrange furniture with drag-and-drop. Customize position, rotation, and scale.
                </p>
              </div>
            </div>
          </div>
        ) : (
          /* Projects List - Has Projects */
          <>
            {/* Projects Header */}
